...
const TeamSchema = new mongoose.Schema({
  id: { type: String, required: "Team ID is required" },
  name: { type: String, trim: true, required: "Team name is required" },
  score: { type: Number, default: 0 },
  strikes: { type: Number, default: 0 }
});

const ActiveSessionSchema = new mongoose.Schema({
  id: { type: String, required: "Session ID is required", unique: true },
